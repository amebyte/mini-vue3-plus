...
function watch(source, cb, options) {
    var getter = source;
    var scheduler = function () { return cb(); };
...
export { createApp, createHook, createRenderer, createTextVNode, getCurrentInstance, h, inject, injectHook, nextTick, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onMounted, onUnmounted, onUpdated, provide, proxyRefs, reactive, ref, renderSlots, watch };
