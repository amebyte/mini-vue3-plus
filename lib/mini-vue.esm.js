    ...
    if (target) {
        ...
        var wrappedHook = hook.__weh ||
            (hook.__weh = function () {
                ...
                var res = args ? hook.apply(void 0, args) : hook();
                return res;
            });
...
export { createApp, createHook, createRenderer, createTextVNode, getCurrentInstance, h, inject, injectHook, nextTick, onBeforeMount, onMounted, provide, proxyRefs, ref, renderSlots };
